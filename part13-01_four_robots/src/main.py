...
window.fill((0, 0, 0))
window.blit(robot, (0, 0))  #top left
window.blit(robot, (640-width, 0))  #top right
window.blit(robot, (0, 480-height))  #bottom left
window.blit(robot, (640-width, 480-height))  #bottom right
pygame.display.flip()
